...
ALIVE_MSG: process.env.ALIVE_MSG || "HEY DEAR, I'm thrilled to announce that Arslan-Botz is ALIVE now—ready to dive into new adventures with you!",
...
OWNER_NAME: process.env.OWNER_NAME || "Arslan-Botz",
